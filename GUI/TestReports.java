 ...
 * @author Asitha Imala
 */
public class TestReports extends javax.swing.JFrame {
    ...
    public void LoadMLT() {
        try {
            Connection con = DB.connect();
            ResultSet r = con.createStatement().executeQuery("select * from employee where position = '" + "MLT" + "'");
            while (r.next()) {
    ...
    public void submitDetails() {
        try {
            ...
            if (!jTextField1.getText().isEmpty() && !jTextField7.getText().isEmpty() && !jTextField8.getText().isEmpty()) {
                ...
                PreparedStatement r = con.prepareStatement("insert into test values('" + jTextField7.getText() + "','" + realdate + "','" + empid + "','" + jTextField1.getText() + "','" + jTextField8.getText() + "','" + jTextArea1.getText() + "')");
                r.executeUpdate();
                r.close();
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Test"));
        ...
        jPanel3.add(dateChooserCombo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 50, 160, -1));

        jPanel3.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 90, 160, -1));
        jPanel3.add(jTextField7, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 20, 160, -1));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 80, 180, 230));
        ...
        jPanel1.add(jTextField9, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 40, 110, -1));

        jLabel5.setText("Patient ID");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 40, -1, -1));

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel11.setText("Test Report");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 10, 210, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestReports.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TestReports().setVisible(true);
            }
        });
    }
